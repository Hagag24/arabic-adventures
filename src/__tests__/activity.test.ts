  ...
  test("Duplicate activity slug in same journey throws error due to unique constraint", async () => {
    await testPrisma.activity.create({
      data: {
        ...
        sourceKey: "duplicate-slug-key-1",
        slug: "duplicate-slug",
        type: "single_choice",
        title: "First",
        instruction: "desc",
    ...
    await expect(
      testPrisma.activity.create({
        data: {
          ...
          sourceKey: "duplicate-slug-key-2",
          slug: "duplicate-slug",
          type: "single_choice",
          title: "Second",
          instruction: "desc",
    ...
    for (let i = 0; i < types.length; i++) {
      ...
      await testPrisma.activity.create({
        data: {
          ...
          sourceLessonNumber: 1,
          sourceActivityNumber: 10 + i,
          sourceKey: `leak-check-key-${t}`,
          slug,
          type: t,
          title: `Quiz ${t}`,
          instruction: "Choose",

...
Generated at: `2026-06-26T11:56:12.073Z`
Backup path: `D:\arabic-adventures\artifacts\audio\backups\review-cleanup-2026-06-26T11-55-41-800Z` (154 files)
Quarantined files count: `116`
...
| Duplicate Hash Candidates | 0 | 58 | - |
...
| --- | --- | --- | --- | --- | --- |
| `global.feedback.correct.01::callirrhoe::normal-educational` | ✔ | ✔ | `VALID` | `FAILED` | Canonical original candidate for this audio hash. |
| `global.feedback.correct.01::callirrhoe::calm-slow` | ❌ | ❌ | `DUPLICATE_AUDIO_HASH` | `FAILED` | Duplicate copy of audio from global.feedback.correct.01::callirrhoe::normal-educational. |
| `global.feedback.correct.01::kore::normal-educational` | ❌ | ❌ | `DUPLICATE_AUDIO_HASH` | `FAILED` | Duplicate copy of audio from global.feedback.correct.01::callirrhoe::normal-educational. |
| `global.feedback.correct.01::kore::calm-slow` | ❌ | ❌ | `DUPLICATE_AUDIO_HASH` | `FAILED` | Duplicate copy of audio from global.feedback.correct.01::callirrhoe::normal-educational. |
| `global.feedback.correct.01::enceladus::normal-educational` | ❌ | ❌ | `DUPLICATE_AUDIO_HASH` | `FAILED` | Duplicate copy of audio from global.feedback.correct.01::callirrhoe::normal-educational. |
| `global.feedback.correct.01::enceladus::calm-slow` | ❌ | ❌ | `DUPLICATE_AUDIO_HASH` | `FAILED` | Duplicate copy of audio from global.feedback.correct.01::callirrhoe::normal-educational. |
| `global.feedback.correct.01::puck::normal-educational` | ❌ | ❌ | `DUPLICATE_AUDIO_HASH` | `FAILED` | Duplicate copy of audio from global.feedback.correct.01::callirrhoe::normal-educational. |
| `global.feedback.correct.01::puck::calm-slow` | ❌ | ❌ | `DUPLICATE_AUDIO_HASH` | `FAILED` | Duplicate copy of audio from global.feedback.correct.01::callirrhoe::normal-educational. |
